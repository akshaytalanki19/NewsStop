...
export default class News extends Component {
  ...
  async componentDidMount() {
    try {
      let url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=3087bb46c64e41148e49ec999a2fbe00&page=1&pageSize=21";
  ...
  handleNextClick = async()=>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=3087bb46c64e41148e49ec999a2fbe00&page=${this.state.page+1}&pageSize=21`;
    let data = await fetch(url);
    let parseData = await data.json();
